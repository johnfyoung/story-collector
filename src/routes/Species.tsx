...
export default function Species() {
  ...
  async function remove(id: string) {
    ...
    const next: StoryContent = {
      ...content,
      species: content.species.filter((x) => x.id !== id),
    };
  ...
  return (
    <div style={{ display: "grid", gap: 16 }}>
      ...
      >
        ...
        {storyId ? (
          <a
            href={`/stories/${storyId}/species/new`}
      ...
      {content ? (
        <SearchBox
          value={query}
          onChange={setQuery}
          suggestions={content.species.map((e) => e.name)}
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map((el) => (
              <Card
                ...
                onClick={() =>
                  storyId &&
                  navigate(`/stories/${storyId}/species/${el.id}/edit`)
                }
              >
                <div
                  style={{
